...
--
-- Host: localhost
-- Generation Time: Jun 21, 2022 at 07:38 PM
...
CREATE TABLE `instructor` (
  ...
  `instructor_mobile` varchar(10) NOT NULL,
  `instructor_address` varchar(5000) NOT NULL,
...
CREATE TABLE `member_workout_plan` (
  ...
  `plan_ref` varchar(5000) NOT NULL,
...
CREATE TABLE `workout` (
  ...
  `workout_name` varchar(500) NOT NULL,
  `workout_description` varchar(5000) NOT NULL,
  `workout_cost` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
--
ALTER TABLE `member`
  MODIFY `member_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `workout`
  MODIFY `workout_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
