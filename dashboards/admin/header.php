                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="add-workouts.php">Add
                                        Workout</a></li>
                                <li class="nav-item"> <a class="nav-link" href="all-workouts.php">All Work Outs</a></li>
                                <li class="nav-item"> <a class="nav-link" href="print-workout.php">Print Workout</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="all-bookings.php"> List Bookings
                                    </a>
                                </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="charts">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="all-payments.php">All Transactions</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="tables">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="add-instructor.php">Add
                                        Instructor
                                    </a></li>
                                <li class="nav-item"> <a class="nav-link" href="all-instructors.php">All
                                        Instructors
                                    </a></li>
                                <li class=" nav-item"> <a class="nav-link" href="print-instructor.php">Print
                                        Instructors List
                                    </a></li>
                            </ul>
                        </div>
