...
if (empty($full_name) || empty($username) || empty($phone_number) || empty($email) || empty($gender) || empty($password) || empty($confirmpassword) || empty($date_of_birth) || empty($end_date) || empty($start_date)) {
    $message = "
        <script>
